...
class CameraClick(BoxLayout):
    ...
    def capture(self):
        ...
        img=r"C:\Users\Dell\OneDrive\Desktop\wasteclassfication\a"+self.i+".jpeg"
        self.d=img
        print(img)
    ...
    def model(self):
        if self.t==True:
            ...
            self.i=self.i-1
            self.i=str(self.i)
            image_path=r"C:\Users\Dell\OneDrive\Desktop\wasteclassfication\a"+self.i+".jpeg"
        
        print("for model")
        print(self.i)
        print(image_path)
        model = load_model(r"C:\Users\Dell\OneDrive\Desktop\wasteclassfication\final_model.h5")
        try:
